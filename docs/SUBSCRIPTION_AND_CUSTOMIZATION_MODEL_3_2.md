# KEY CASTRO — Managed Subscription + Paid Customization Contract (3.2.0)

## Current commercial model

KEY CASTRO has two primary commercial offers:

1. **Managed System Subscription** — ongoing managed access to an existing ready-made system. Monthly or yearly terms and pricing are discussed before activation. The public site does not invent prices, user/storage quotas, or unlimited-resource promises. Subscription access does not transfer ownership of the core software.
