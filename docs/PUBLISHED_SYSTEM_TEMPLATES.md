...
Every published existing system uses the same **$160 one-time** purchase price. That price is for the existing system as shown; requested changes are separate upgrades. Maintenance and future development are separate. Maintenance does not include new features, workflow changes, new modules, integrations, or other later improvements. Future improvements can be purchased as **Minor System Upgrade — $79** or **Major System Upgrade — $149**; **New System / Large Expansion** uses **Price by Agreement**.
