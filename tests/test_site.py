...
class PortfolioSiteTests(unittest.TestCase):
    ...
    def test_health_endpoint(self):
        ...
        self.assertEqual(data["version"], "3.8.19")
    ...
    def test_about_professional_portrait_is_scoped_and_available(self):
        ...
        self.assertIn(b"Built around your workflow", about.data)
        self.assertIn(b"Automation", about.data)
        ...
        css_path = Path(__file__).resolve().parents[1] / "app" / "static" / "css" / "style.css"
        css = css_path.read_text(encoding="utf-8")
        self.assertIn("3.8.7 — APPROVED ABOUT TOP PROFILE REDESIGN", css)
        self.assertIn(".about-page-hero .about-intro-layout", css)
    ...
    def test_managed_maintenance_and_customization_are_clear_without_changing_contact_flow(self):
        ...
        self.assertIn(b"$290", systems.data)
        ...
        self.assertIn(b"$290", detail.data)
        ...
        self.assertIn(b"$290", services.data)
    ...
    def test_existing_system_price_has_one_trusted_source_and_is_separate_from_upgrades(self):
        ...
        self.assertEqual(pricing.one_time_price, 290)
        self.assertEqual(pricing.price_label, "$290")
        self.assertEqual(pricing.one_time_label, "$290 one-time")
        ...
        self.assertGreaterEqual(home.data.count(b"$290"), 3)
        self.assertGreaterEqual(systems.data.count(b"$290"), 3)
        self.assertIn(b"$290", services.data)
    ...
    def test_managed_handover_customization_and_custom_build_context_flow(self):
        ...
        self.assertIn(b"Property Inventory Hub", purchase.data)
        self.assertIn(b'name="source_intent" value="existing-system"', purchase.data)
        self.assertIn(b"Send Message", purchase.data)
